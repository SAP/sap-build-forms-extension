		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Forms",
									"targetURL": "#formssbpauiworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"formssbpauiworkflowuimodule-display": {
								"semanticObject": "formssbpauiworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=forms.sbpa.taskui.workflowuimodule",
									"url": sap.ui.require.toUrl("forms/sbpa/ui/workflowuimodule")
								}
							}
						}
					}
