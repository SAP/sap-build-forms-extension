...
import com.sap.openapi.sbpaworkflow.model.TechnicalErrorErrorDetailsInner;
...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public TechnicalErrorError code( @Nullable final String code) {
    this.code = code;
    return this;
  }
   ...
   * @return The same instance of this {@link TechnicalErrorError} class
   */
  @Nonnull public TechnicalErrorError logId( @Nullable final String logId) {
    this.logId = logId;
    return this;
  }
   ...
   * @return The same instance of this {@link TechnicalErrorError} class
   */
  @Nonnull public TechnicalErrorError details( @Nullable final List<TechnicalErrorErrorDetailsInner> details) {
   ...
   */
  @Nonnull
  public List<TechnicalErrorErrorDetailsInner> getDetails() {
    return details;
  }
   ...
   * @param details  The details of this {@link TechnicalErrorError}
   */
  public void setDetails( @Nullable final List<TechnicalErrorErrorDetailsInner> details) {
    this.details = details;
  }
  ...
  /**
   * Get the value of all properties of this {@link TechnicalErrorError} instance including unrecognized properties.
   *
