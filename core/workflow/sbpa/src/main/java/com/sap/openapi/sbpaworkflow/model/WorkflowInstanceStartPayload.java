...
// CHECKSTYLE:ON
{
   ...
   *
   * @param definitionId  Specify the ID of the workflow definition for which an instance should be started. The ID is at most 255 characters long.
  ...
  /**
   * Specify the ID of the workflow definition for which an instance should be started. The ID is at most 255 characters long.
   ...
   * @return The same instance of this {@link WorkflowInstanceStartPayload} class
   */
  @Nonnull public WorkflowInstanceStartPayload context( @Nullable final Object context) {
  ...
  /**
   * Get the value of all properties of this {@link WorkflowInstanceStartPayload} instance including unrecognized properties.
   *
