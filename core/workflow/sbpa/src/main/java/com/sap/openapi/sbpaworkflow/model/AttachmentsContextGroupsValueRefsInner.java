...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public AttachmentsContextGroupsValueRefsInner objectId( @Nullable final String objectId) {
  ...
  /**
   * Get the value of all properties of this {@link AttachmentsContextGroupsValueRefsInner} instance including unrecognized properties.
   *
  ...
  public Map<String, Object> toMap()
  {
    ...
    if( objectId != null ) declaredFields.put("objectId", objectId);
