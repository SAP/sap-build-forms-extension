...
import com.sap.openapi.sbpaworkflow.model.FormMetadataWorkflowDefinitionsInner;
...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public FormMetadata id( @Nullable final String id) {
    this.id = id;
    return this;
  }
   ...
   * @return The same instance of this {@link FormMetadata} class
   */
  @Nonnull public FormMetadata name( @Nullable final String name) {
    this.name = name;
    return this;
  }
   ...
   * @return The same instance of this {@link FormMetadata} class
   */
  @Nonnull public FormMetadata version( @Nullable final Integer version) {
   ...
   * @return The same instance of this {@link FormMetadata} class
   */
  @Nonnull public FormMetadata revision( @Nullable final String revision) {
   ...
   * @return The same instance of this {@link FormMetadata} class
   */
  @Nonnull public FormMetadata type( @Nullable final TypeEnum type) {
    this.type = type;
    return this;
  }
   ...
   * @return The same instance of this {@link FormMetadata} class
   */
  @Nonnull public FormMetadata createdAt( @Nullable final OffsetDateTime createdAt) {
   ...
   * @return The same instance of this {@link FormMetadata} class
   */
  @Nonnull public FormMetadata createdBy( @Nullable final String createdBy) {
   ...
   * @return The same instance of this {@link FormMetadata} class
   */
  @Nonnull public FormMetadata workflowDefinitions( @Nullable final List<FormMetadataWorkflowDefinitionsInner> workflowDefinitions) {
   ...
   */
  @Nonnull
  public List<FormMetadataWorkflowDefinitionsInner> getWorkflowDefinitions() {
   ...
   * @param workflowDefinitions  A list of workflow definitions in case the form definition version is of type &#39;start&#39;
   */
  public void setWorkflowDefinitions( @Nullable final List<FormMetadataWorkflowDefinitionsInner> workflowDefinitions) {
    this.workflowDefinitions = workflowDefinitions;
  }
  ...
  /**
   * Get the value of all properties of this {@link FormMetadata} instance including unrecognized properties.
   *
  ...
  public Map<String, Object> toMap()
  {
    ...
    if( workflowDefinitions != null ) declaredFields.put("workflowDefinitions", workflowDefinitions);
