...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public SampleContext id( @Nullable final String id) {
    this.id = id;
    return this;
  }
   ...
   * @return The same instance of this {@link SampleContext} class
   */
  @Nonnull public SampleContext content( @Nullable final Object content) {
   ...
   * @return The same instance of this {@link SampleContext} class
   */
  @Nonnull public SampleContext modelElementId( @Nullable final String modelElementId) {
   ...
   * @param modelElementId  The ID of the start event for which the default start context is configured. The ID is at most 255 characters long.
   */
  public void setModelElementId( @Nullable final String modelElementId) {
    this.modelElementId = modelElementId;
  }
  ...
  /**
   * Get the value of all properties of this {@link SampleContext} instance including unrecognized properties.
   *
  ...
  public Map<String, Object> toMap()
  {
    ...
    if( modelElementId != null ) declaredFields.put("modelElementId", modelElementId);
