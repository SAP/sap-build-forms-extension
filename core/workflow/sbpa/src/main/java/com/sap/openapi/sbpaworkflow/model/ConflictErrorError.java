...
// CHECKSTYLE:ON
{
   ...
   * @return The same instance of this {@link ConflictErrorError} class
   */
  @Nonnull public ConflictErrorError logId( @Nullable final String logId) {
    this.logId = logId;
    return this;
  }
  ...
  /**
   * Get the value of all properties of this {@link ConflictErrorError} instance including unrecognized properties.
   *
