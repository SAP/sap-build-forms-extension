...
// CHECKSTYLE:ON
{
   ...
   * @return The same instance of this {@link TaskDefinition} class
   */
  @Nonnull public TaskDefinition attributeDefinitions( @Nullable final List<TaskDefinitionAttributeListInner> attributeDefinitions) {
  ...
  /**
   * Get the value of all properties of this {@link TaskDefinition} instance including unrecognized properties.
   *
