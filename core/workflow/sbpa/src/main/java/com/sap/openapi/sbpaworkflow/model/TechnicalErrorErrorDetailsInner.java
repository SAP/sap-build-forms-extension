...
// CHECKSTYLE:ON
{
   ...
   */
  @Nonnull public TechnicalErrorErrorDetailsInner severity( @Nullable final String severity) {
   ...
   * @param severity  The severity of the error.
   */
  public void setSeverity( @Nullable final String severity) {
    this.severity = severity;
  }
   ...
   * @return The same instance of this {@link TechnicalErrorErrorDetailsInner} class
   */
  @Nonnull public TechnicalErrorErrorDetailsInner message( @Nullable final String message) {
  ...
  /**
   * Get the value of all properties of this {@link TechnicalErrorErrorDetailsInner} instance including unrecognized properties.
   *
