...
/**
 * Definition of a document-form element.
 */
@EqualsAndHashCode(callSuper = true)
@Data
public class DocFormElementDefinition extends ElementDefinition {
     ...
     * Default constructor.
     */
    public DocFormElementDefinition() {
        super(UIElementType.DocForm);
    }
